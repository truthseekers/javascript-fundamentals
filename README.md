...
drag and drop the index.html files into the browser to see the code running. (in the dev tools)

Visit https://truthseekers.io/javascript-tutorial

to get all of our JavaScript courses and tutorials
